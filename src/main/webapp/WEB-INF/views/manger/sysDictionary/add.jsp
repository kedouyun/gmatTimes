...
<div id="rapp" >
		...
		<form class="form-horizontal" id="commentForm"  action="${basePath}/manger/sysDictionary/save.do" method="POST">
				...
				<div class="form-group">
				   	...
				   	<div class="col-sm-6">
					    <select class="form-control" name="dictionaryTypeId" required>
