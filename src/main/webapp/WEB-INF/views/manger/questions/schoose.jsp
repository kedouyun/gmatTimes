	    ...
	    <form class="form-inline definewidth m20" action="<%=basePath%>/manger/questions/schoose.do" method="post">
			<div class="panel-body">
			  ...
			  <%--   <button type="button" url="<%=basePath %>/manger/questions/delete.do" class="btn btn-danger option_deletes"><i class="fa fa-trash-o"></i>&nbsp;删除</button> --%>
			    <button type="button" url="<%=basePath %>/manger/questions/schooseSave.do" class="btn btn-danger option_save"><i class="fa fa-trash-o"></i>&nbsp;保存组合</button>
		    </div>
