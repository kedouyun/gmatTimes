...
import com.app.sys.entity.SysColumn;
import com.app.sys.entity.SysTable;
...
public class GeneratorUtils {
	...
	public static List<String> getTemplates(){
		...
		templates.add("templates/generator/add.jsp.vm");
...
//		templates.add("templates/generator/list.js.vm");
	...
	public static void generatorCode(Map<String, String> table,
		...
		for(String template : templates){
			...
			try {
				...
				throw new SelfException("渲染模板失败，表名：" + sysTable.getTableName(), e);
			}
		}
	}
	...
	public static Configuration getConfig(){
		try {
			...
			throw new SelfException("获取配置文件失败，", e);
		}
	}
	...
	public static String getFileName(String template, String className, String classname, String packageName){
		...
		if(template.contains("list.jsp.vm")){
			return "main" + File.separator + "resources" + File.separator + "views" + File.separator
					+ "modules" + File.separator + "manger" + File.separator + classname+ File.separator + "list.jsp";
		}
		if(template.contains("add.jsp.vm")){
			return "main" + File.separator + "resources" + File.separator + "views" + File.separator
					+ "modules" + File.separator + "manger" + File.separator + classname+ File.separator + "add.jsp";
		}
		if(template.contains("edit.jsp.vm")){
			return "main" + File.separator + "resources" + File.separator + "views" + File.separator
					+ "modules" + File.separator + "manger" + File.separator + classname+ File.separator + "edit.jsp";
		}
//		if(template.contains("add.jsp.vm")){
