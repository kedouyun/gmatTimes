...
import com.app.sys.dao.SysMenuDao;
import com.app.sys.dao.SysUserDao;
import com.app.sys.entity.SysMenu;
import com.app.sys.entity.SysUser;
import com.app.sys.redis.SysUserRedis;
...
public class SysUserServiceImpl implements SysUserService {
	...
	public SysUser queryByUserName(String username) {
		SysUser sysUser=null;//sysUserRedis.get(username);
		if(sysUser==null){
...
//		if(sysUser==null){
		SysUser sysUser=sysUser=sysUserDao.queryObject(id);
			sysUserRedis.saveOrUpdate(sysUser);
//		}
		return sysUser;
	}
