...
<body>
	...
	<div class="s-gmat-main"
		...
		<div class="s-gmat-header">
			...
			<div class="s-header-right">
				...
				<p class="s-location" id="js-location" data-questionseq="1">
					<i></i><span>Location ${arrId+1} of ${questionsNum}</span>
				</p>
			</div>
		</div>
		<!-- 收藏/设置条 -->
		...
		<!-- 练习题容器 -->
		<form method="POST" action="${baseurl}/gmat/pre/practice/${grammarGroupId}/${rediskey}/${arrId}"
			...
			<input name="_token" type="hidden" value="WskYEKeSTfjX3OXhlW2da8cf6cZut1WikCYsPC2m">
				 ...
				 <input id="examUnique" name="exam_unique" type="hidden" value="u1511355500987423"> 
			...
			<input name="type" type="hidden" value="101"> <input
				...
				<input type="hidden" id="grammarGroupId" value="${grammarGroupId}">
...
<script type="text/javascript">
	...
	$(".js-enter-btn").click(function(){
		$("#overExem").val("1");
		$("#questionForm").attr("action","${baseurl}/gmat/practice/selfresult/"+$("#grammarGroupId").val()+"/"+$("#u").val());
		$("#questionForm").submit();
	})
