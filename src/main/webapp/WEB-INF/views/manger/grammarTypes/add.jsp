...
<div id="rapp" >
		...
		<form class="form-horizontal" id="form_table" action="${basePath}/manger/grammartypes/save.do" method="POST">
			<div class="form-group">
				<label class="col-sm-2 control-label">名称</label>
				<div class="col-sm-6">
					<input type="text" class="form-control" name="name" v-model="user.nickname" placeholder="别名"/>
				</div>
			</div>
			<div class="form-group">
