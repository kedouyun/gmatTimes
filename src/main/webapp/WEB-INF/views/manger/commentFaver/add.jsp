...
<div id="rapp" >
		...
		<form class="form-horizontal" id="commentForm"  action="/sys/commentFaver/save.do" method="POST">
				      ...
				      <input type="text" class="form-control" name="memberId" value="" placeholder="" required/>
				   	...
				   	<label class="col-sm-2 control-label"></label>
				   	<div class="col-sm-6">
				      <input type="text" class="form-control" name="commentId" value="" placeholder="" required/>
				    </div>
				</div>
											<div class="form-group">
				<label class="col-sm-2 control-label"></label>
