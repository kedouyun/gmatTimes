...
<div id="rapp" >
		...
		<form class="form-horizontal" id="commentForm"  action="${basePath}/manger/exampaper/save.do" method="POST">
							...
							<div class="form-group">
							   	...
							   	<div class="col-sm-6">
							      <textarea rows="5" cols="10" class="form-control" name="remark"></textarea>
							    </div>
							</div>
				<div class="form-group">
